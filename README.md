...
Our approach is to insert an intermediate language of simple python data structures between the Slack history processing and the PDF generation. Then we add an adapter to go from that intermediate language to JSON when desired.
